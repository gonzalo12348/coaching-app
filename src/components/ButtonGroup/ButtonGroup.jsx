...
function ButtonGroup() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px', padding: '20px' }}>
      ...
      <img onClick={() => window.location.assign("https://www.instagram.com/gonza.arancibiaa/")} src={imgIG} style={{ cursor: "pointer", width: "50px", marginRight: 10}}/>
      <img onClick={() => window.location.assign("https://www.youtube.com/@gonzaarancibia")} src={imgYT} style={{ width: "50px" ,cursor: "pointer",}}/>
      </div>
    </div>
  );
}
